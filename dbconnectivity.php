...
$sql="SELECT * FROM user_credentials WHERE username='$user'";
$sqlemail="SELECT * FROM user_credentials WHERE email='$email'";
...
else
{
    if ($pass == $cnfpass)
    {
      $sql="INSERT INTO user_credentials(username,email,password) VALUES('$user','$email','$pass')";
      $res=mysqli_query($conn,$sql);
      if($res)
    {
